...
(2) fill 'star_mass' with 5% NaN, 'star_metallicity' with 16% NaN
    ,'eccentricity' with 50% NaN, 'temp_calculated' with 63% NaN, 
    'radius' with 23% NaN by KNN
(3) fill remain features which have less than 10% NaN by median
(4) save to a new dataset named preprocessed.csv
-------------------------------------------------------------
...
df1 = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_D_A_A/exoplanet.eu_catalog_03-08-26_16_42_07.csv')
dff = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_D_A_A/exoplanet.eu_catalog_03-08-26_16_42_07.csv', usecols=use_cols)
df = dff.copy()
print('='*50)
print('')
#===================================================================
...
df.to_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_D_A_A/preprocessed.csv')
