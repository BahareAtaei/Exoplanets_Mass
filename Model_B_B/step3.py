...
step3: COMPELETE DATASET FOR CALCULATION
       with 'eccentricity', 'temp_calculated'

(1) check that why we removed NaN radiuses in the first place
(2) merging prepricessed.csv and filled_modelA_A.csv and save final dataset to modelA_A.csv
...
# import files
df_original = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_B_B/preprocessed.csv')
df_modelB_B = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_B_B/filled_modelB_B.csv')
#=============================================
...
df_final = pd.concat([df_modelB_B, removed_planets], ignore_index = True)
...
df_final.to_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_B_B/modelB_B.csv', index=False)
