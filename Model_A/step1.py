...
(3) drop 'eccentricity' with 50% NaN, 'temp_calculated' with 63% NaN
(4) fill 'star_mass' with 5% NaN, 'star_metallicity' with 16% NaN by KNN
(5) fill remain features which have less than 10% NaN by median
(6) save to a new dataset named preprocessed.csv
--------------------------------------------------------
...
df1 = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_A/exoplanet.eu_catalog_03-08-26_16_42_07.csv')
dff = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_A/exoplanet.eu_catalog_03-08-26_16_42_07.csv', usecols=use_cols)
df = dff.copy()
print('='*50)
print('')
#==================================================================
...
# model A is without eccentricity, temp_calculated
df = df.drop(columns=['eccentricity', 'temp_calculated'])
#========================================================
...
df.to_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_A/preprocessed.csv', index=False)
