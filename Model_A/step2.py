"""
step2: RANDOM FOREST REGRESSOR MODEL (without eccentricity, temp_calculated)
----------------------------------------------------------
...
dff = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_A/preprocessed.csv')
df = dff.copy()
#==============================================
...
unknown['log_mass'] = predict_log_mass
...
filled_mass_dataset.to_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_A/filled_modelA.csv', index=False)
