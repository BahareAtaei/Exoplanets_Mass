"""
sstep2: RANDOM FOREST REGRESSOR MODEL (with eccentricity, temp_calculated)
-------------------------------------------------------------------------
...
dff = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_D_B_B/preprocessed.csv')
df = dff.copy()
#==============================================
...
filled_mass_dataset.to_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_D_B_B/filled_modelB_B.csv', index=False)
