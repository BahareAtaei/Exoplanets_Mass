...
df1 = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_A_A/exoplanet.eu_catalog_03-08-26_16_42_07.csv')
dff = pd.read_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_A_A/exoplanet.eu_catalog_03-08-26_16_42_07.csv', usecols=use_cols)
df = dff.copy()
print('='*50)
print('')
#===================================================================
...
print('Check Missing Values: After fill Columns With Median')
missing_values = pd.DataFrame(
    {
        'Missing': df.isnull().sum(),
        'Percent': (df.isnull().mean() * 100).round(2)
...
# fill by KNN -> star_metallicity, star_mass, eccentricity, temp_calculated
num_cols = [
    'star_mass',
    'star_metallicity',
    'eccentricity',       
...
df.to_csv('/Users/ershadataei/Documents/Bahare/Programming/Python/Project_Python/ALL EXOPLANETS/RandomForestRegressor/Model_A_A/preprocessed.csv', index=False)
