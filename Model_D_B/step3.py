...
# import files
df_original = pd.read_csv(r'C:\Users\Sisto\Documents\Programming\Python\Projects\Exoplanets\RandomForestRegressor\Model_D\Model_D_B\preprocessed.csv')
df_modelA = pd.read_csv(r'C:\Users\Sisto\Documents\Programming\Python\Projects\Exoplanets\RandomForestRegressor\Model_D\Model_D_B\filled_modelB.csv')
#=============================================
...
df_final.to_csv(r'C:\Users\Sisto\Documents\Programming\Python\Projects\Exoplanets\RandomForestRegressor\Model_D\Model_D_B\modelB.csv', index=False)
