...
# import files
df_original = pd.read_csv(r'C:\Users\Sisto\Documents\Programming\Python\Projects\Exoplanets\RandomForestRegressor\Model_D\Model_D_C_C\preprocessed.csv')
df_modelA = pd.read_csv(r'C:\Users\Sisto\Documents\Programming\Python\Projects\Exoplanets\RandomForestRegressor\Model_D\Model_D_C_C\filled_modelC_C.csv')
#=============================================
...
df_final.to_csv(r'C:\Users\Sisto\Documents\Programming\Python\Projects\Exoplanets\RandomForestRegressor\Model_D\Model_D_C_C\modelC_C.csv', index=False)
